...
class TestStep5(AssignmentTester):
    ...
    def test_empty_cell(self, message):
        ...
        empty_cell = test_file.EmptyCell()
    ...
    def test_terminal_draw(self, mock_input, mock_stdout, message):
        ...
        terminal.name, terminal.board_size, terminal.number_of_mines = test_file.register_user()
        terminal.current_board = Board(terminal.board_size)
        terminal.draw()
